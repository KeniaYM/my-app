...
class CicloVidaComponents extends Component {
  constructor(props) {
    super(props);
    this.state = {
      nombre: "Alberto",
  ...
  //montamos el complemento(eventos, peticiones http)
  componentDidMount() {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (prevState === this.state.nombre) {
      ...
      console.log(
        'Mi estado si ha cambiado y ahora me llamo',this.state.nombre);
    }
  }
...
export default CicloVidaComponents;